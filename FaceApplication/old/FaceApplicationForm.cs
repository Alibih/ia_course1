...
namespace FaceApplication
{
    ...
    /// <summary>
    /// made the animation stop when not in use, and start when in use I would rather pause/unpause, but currently i cannot do anyhting about That.
    /// </summary>
    ...
    public partial class FaceApplicationForm : Form
    {
        ...
        {
            Console.WriteLine("shaking head");
            ShakeHead();
        ...
        public ColorListBox CommunicationLogListBox
        {
            get { return communicationLogListBox; }
        }
    }
