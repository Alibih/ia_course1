   ...
   //     private FaceDetector faceDetector = null;
        ...
        private void HandleFaceDetected(object sender, FaceDetectionEventArgs e)
        {
           ...
           /*    string information = DateTime.Now.ToString("yyyyMMdd HH:mm:ss") + " Face detected. Bounding box: (" + e.Left.ToString() + "," +
                e.Top.ToString() + "," + e.Right.ToString() + "," + e.Bottom.ToString() + ")" + faceDetectionColorListBox.ForeColor.ToString();
        ...
        #region  detectionfrequency
        bool FaceDetected = false;
        float minFaceFrequency = 4500;
        float maxFaceFrequency = 7500;
        float interpolatedFrequency = 26500;
        int minRectangleSize = 150;
